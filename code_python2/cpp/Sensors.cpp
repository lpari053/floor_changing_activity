...
Sensors::Sensors() : step(0),baro(0.0),_baro_norm(0.0),
...
Sensors::Sensors(int step,double baro,double acc_x, double acc_y, double acc_z, double gyro_x, double gyro_y, double gyro_z,double mag_x, double mag_y, double mag_z) :
step(step),baro(baro),_acc_x(acc_x), _acc_y(acc_y), _acc_z(acc_z), _gyro_x(gyro_x), _gyro_y(gyro_y), _gyro_z(gyro_z), _mag_x(mag_x), _mag_y(mag_y), _mag_z(mag_z), 
_acc_norm_nf(0.0), _gyro_norm_nf(0.0), _acc_norm(0.0), _gyro_norm(0.0), _mag_norm(0.0), _mag_norm_nf(0.0) {}
