...
def showing(folder):
    fichier=os.listdir(f'../1_data/data/data_interpolate/')
    
    for i in range(0,len(fichier)):
        fich=fichier[i]
        
        data_acc=pd.read_csv(f'../1_data/data/data_interpolate/{fich}/ACC.txt',header=None)
        data_gyr=pd.read_csv(f'../1_data/data/data_interpolate/{fich}/GYR.txt',header=None)
        data_mag=pd.read_csv(f'../1_data/data/data_interpolate/{fich}/MAG.txt',header=None)
        data_baro=pd.read_csv(f'../1_data/data/data_interpolate/{fich}/BARO.txt',header=None)
